...
OXE_DATASET_CONFIGS = {
    ...
    "my_aloha_picking_banana_112_demos": {
        "image_obs_keys": {"primary": "cam2", "secondary": None, "left_wrist": "cam1", "right_wrist": "cam3"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
        "action_encoding": ActionEncoding.JOINT_POS_BIMANUAL,
    ...
    "my_aloha_picking_banana_relative": {
        ...
        #my_aloha_pick_put_cube_30demos
    "my_aloha_pick_put_cube": {
        ...
        #my_aloha_pick_put_banana_sink_47demos
    "my_aloha_picking_banana_sink": {
        ...
        #my_aloha_pick_put_mint_sink_72demos
    "my_aloha_pick_put_mint_sink": {
        ...
        "action_encoding": ActionEncoding.JOINT_POS_BIMANUAL,
            ...
            #my_aloha_pick_put_mint_basket_69demos
    "my_aloha_pick_put_basket_sink": {
        "image_obs_keys": {"primary": "cam2", "secondary": None, "left_wrist": "cam1", "right_wrist": "cam3"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
    ...
    "my_aloha_sim_adjust_bottle":{
        "image_obs_keys": {"primary": "cam1", "secondary": None, "left_wrist": "cam2", "right_wrist": "cam3"},
        "depth_obs_keys": {"primary": None, "secondary": None, "wrist": None},
        "state_obs_keys": ["state"],
        "state_encoding": StateEncoding.JOINT_BIMANUAL,
        "action_encoding": ActionEncoding.JOINT_POS_BIMANUAL,
