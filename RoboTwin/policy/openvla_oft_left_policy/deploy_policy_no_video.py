...
sys.path.insert(0, "/home/jyx/openvla-oft")  # OpenVLA-OFT 项目根目录
...
class OpenVLAConfig:
    ...
    model_family: str = "openvla"
    pretrained_checkpoint: Union[str, Path] = "/new_data/ckpt/openvla-oft/sim/openvla-7b+my_aloha_sim_adjust_bottle_and_stapler_pad+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--473--50000_chkpt"
    use_l1_regression: bool = True
    use_diffusion: bool = False
    use_proprio: bool = True
    use_film: bool = True
