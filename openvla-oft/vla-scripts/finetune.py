...
# # 打印模块路径
# module_path = "experiments.robot.openvla_utils"
# try:
#     module = __import__(module_path, fromlist=["*"])
#     print(f"[INFO]Path to experiments.robot.openvla_utils: {inspect.getfile(module)}")
...
class FinetuneConfig:
    ...
    dataset_name: str = "my_aloha_2_tasks"    # Name of fine-tuning dataset (e.g., `aloha_scoop_x_into_bowl`)
...
def run_forward_pass(
    ...
    with torch.autocast("cuda", dtype=torch.bfloat16):
        output: CausalLMOutputWithPast = vla(#PrismaticCausalLMOutputWithPast,
            #forward在/home/jyx/openvla-oft/prismatic/extern/hf/modeling_prismatic.py的PrismaticForConditionalGeneration
...
def finetune(cfg: FinetuneConfig) -> None:
    ...
    print(f"Number of images in input: {cfg.num_images_in_input}")
