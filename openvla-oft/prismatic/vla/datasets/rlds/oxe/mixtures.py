...
OXE_NAMED_MIXTURES: Dict[str, List[Tuple[str, float]]] = {
    ...
    ###-----------my aloha datasets---------------
    "my_aloha_picking_banana_112_demos": [
        ("my_aloha_picking_banana_112_demos", 1.0),
    ],
    "my_aloha_picking_banana_new": [
        ("my_aloha_picking_banana_new", 1.0),
    ],
    "my_aloha_picking_banana_relative": [
        ("my_aloha_picking_banana_relative", 1.0),
    ],
    "my_aloha_pick_put_cube": [
        ("my_aloha_pick_put_cube", 1.0),
    ],
    "my_aloha_picking_banana_sink": [
        ("my_aloha_picking_banana_sink", 1.0),
    ],
    "my_aloha_pick_put_mint_sink": [
        ("my_aloha_pick_put_mint_sink", 1.0),
    ],
    "my_aloha_4_tasks": [
        ("my_aloha_picking_banana_new", 1.0),
        ("my_aloha_pick_put_cube", 1.0),
    ...
    "my_aloha_sim_adjust_bottle": [
        ("my_aloha_sim_adjust_bottle", 1.0),
    ],
    "my_aloha_sim_stapler_pad": [
        ("my_aloha_sim_stapler_pad", 1.0),
    ],
    "my_aloha_sim_adjust_bottle_and_stapler_pad": [
        ("my_aloha_sim_adjust_bottle", 1.0),
        ("my_aloha_sim_stapler_pad", 1.0),
    ],
    "my_aloha_sim_hanging_mug": [
        ("my_aloha_sim_hanging_mug", 1.0),
    ],
    "my_aloha_sim_adjust_bottle_left": [
        ("my_aloha_sim_adjust_bottle_left", 1.0),
    ],
    "my_aloha_sim_stack_bowls_three": [
        ("my_aloha_sim_stack_bowls_three", 1.0),
    ],
    "my_aloha_sim_grab_roller":[
        ("my_aloha_sim_grab_roller",1.0),
    ],
    "my_aloha_sim_open_laptop":[
        ("my_aloha_sim_open_laptop",1.0),
    ],
    "my_aloha_sim_blocks_ranking_rgb":[
        ("my_aloha_sim_blocks_ranking_rgb",1.0)
    ],
    "my_aloha_sim_put_object_cabinet":[
        ("my_aloha_sim_put_object_cabinet",1.0)
    ],
