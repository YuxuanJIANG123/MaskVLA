...
def aloha_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
    ...
    return trajectory
def my_aloha_dataset_transform(trajectory: Dict[str, Any]) -> Dict[str, Any]:
...
OXE_STANDARDIZATION_TRANSFORMS = {
    ...
    ### MY ALOHA fine-tuning datasets
    "my_aloha_picking_banana_112_demos": my_aloha_dataset_transform,
    "my_aloha_picking_banana_new": my_aloha_dataset_transform,
    "my_aloha_picking_banana_relative": my_aloha_dataset_transform,
    "my_aloha_pick_put_cube":my_aloha_dataset_transform,
    "my_aloha_picking_banana_sink": my_aloha_dataset_transform,
    "my_aloha_pick_put_mint_sink":my_aloha_dataset_transform,
    "my_aloha_pick_put_basket_sink":my_aloha_dataset_transform,

    ## ALOHA Sim datasets
    "my_aloha_sim_adjust_bottle":my_aloha_dataset_transform,
    "my_aloha_sim_stapler_pad":my_aloha_dataset_transform,
    "my_aloha_sim_hanging_mug":my_aloha_dataset_transform,
    "my_aloha_sim_adjust_bottle_left":my_aloha_dataset_transform,
    "my_aloha_sim_stack_bowls_three":my_aloha_dataset_transform,
    "my_aloha_sim_grab_roller":my_aloha_dataset_transform,
    "my_aloha_sim_open_laptop":my_aloha_dataset_transform,
    "my_aloha_sim_blocks_ranking_rgb":my_aloha_dataset_transform,
    "my_aloha_sim_put_object_cabinet":my_aloha_dataset_transform,
}