...
class Base_Task(gym.Env):
    ...
    def get_obs(self):
        ...
        if self.data_type.get("qpos", False):
            ...
            # hjy changes this
            pkl_dic["qpos"] = np.concatenate([left_jointstate, right_jointstate])
    ...
    def merge_pkl_to_hdf5_video(self):
        ...
        target_video_path = f"{self.save_dir}/video/episode{self.ep_num}"
        # target_file_path = f"{self.save_dir}/data/episode{self.ep_num}.hdf5"
