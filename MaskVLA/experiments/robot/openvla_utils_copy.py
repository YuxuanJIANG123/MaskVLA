...
def prepare_images_for_vla(images: List[np.ndarray], cfg: Any) -> List[Image.Image]:
    ...
    for idx, image in enumerate(images):
        ...
        # # ✅ 只保存 cam2（假设它是第一张图）
        # if idx == 0:
        #     save_dir = "/home/jyx/MaskVLA/debug_images"
...
#             # Image.fromarray(image).save("/home/jyx/MaskVLA/debug_images/resized_image.png")
#         # Convert to PIL image
#         image_rgb = image[..., ::-1]  # BGR -> RGB
#         pil_image = Image.fromarray(image_rgb).convert("RGB")
#         pil_image.save("/home/jyx/MaskVLA/debug_images/processed_image.png")
...
def restore_and_save_all(pixel_values, save_dir="/home/jyx/MaskVLA/debug_images"):
    import os
    os.makedirs(save_dir, exist_ok=True)
