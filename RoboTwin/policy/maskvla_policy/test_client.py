...
def test_communication():
    ...
    # 测试参数
    ckpt_path = "/new_data/ckpt/MaskVLA/sim/adjust_bottle/baseline-oft/openvla-7b+my_aloha_sim_adjust_bottle_and_stapler_pad+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--472--50000_chkpt"
