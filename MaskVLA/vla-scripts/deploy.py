...
class DeployConfig:
    ...
    pretrained_checkpoint: Union[str, Path] = "/data/ckpt/MaskVLA/aloha_4_tasks/100000steps/openvla-7b+my_aloha_4_tasks+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--452+my_aloha_4_tasks+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--455"     # Pretrained checkpoint path
