...
def load_scene_info(task_name: str, setting: str, scene_info_path: str) -> Dict[str, Dict]:
    ...
    file_path = f"/new_data/data_robotwin_clean/data/{task_name}/{setting}/scene_info.json"
...
def save_episode_descriptions(task_name: str, setting: str, generated_descriptions: List[Dict]):
    ...
    output_dir = os.path.join(parent_directory, f"/new_data/data_robotwin_clean/data/{task_name}/{setting}/instructions")
