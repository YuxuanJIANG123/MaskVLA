...
torchrun --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune.py \
  ...
  --data_root_dir /data/250010219/yuxuan/data/sim/rlds \
  --dataset_name libero_10_no_noops \
  --run_root_dir /data/250010219/yuxuan/Better-OFT/MaskVLA/ckpt \
...
torchrun --standalone --nnodes 1 --nproc-per-node 1 vla-scripts/finetune.py \
  ...
  --run_root_dir "/data/ckpt/MaskVLA/lerobot_finetune" \
  --use_l1_regression True \
  --use_diffusion False \
  --use_film True \
  ...
  --wandb_project kinova_MaskVLA_1 \
  ...
  --vla_path  /new_data/ckpt/MaskVLA/sim/loss_siglip_dino_1:1/openvla-7b+my_aloha_2_tasks+b4+lr-0.0005+lora-r32+dropout-0.0--image_aug--0801_loss_siglip_dinov2--30000_chkpt \
  --resume True   \
  --resume_step 30000 \
  --data_root_dir /new_data/dataset/openvla-rlds \
  --dataset_name my_aloha_sim_adjust_bottle_and_stapler_pad \
  --run_root_dir /new_data/ckpt/MaskVLA/sim/loss_siglip_dino_1:1 \
  --use_l1_regression True \
  --use_diffusion False \
  --use_film True \
...
# 记得修改/home/jyx/MaskVLA/prismatic/vla/constants.py里面的NUM_ACTIONS_CHUNK
  ...
  --run_root_dir /new_data/ckpt/MaskVLA/sim/hanging_mug/loss_siglip_dino_0.3:0.2 \
  --use_l1_regression True \
  --use_diffusion False \
  --use_film True \
  --num_images_in_input 3 \
  ...
  --run_root_dir /new_data/ckpt/MaskVLA/sim/stack_bowls_three/zero_0.1 \
  --use_l1_regression True \
  --use_diffusion False \
  --use_film True \
  --num_images_in_input 3 \
  ...
  --run_root_dir /new_data/ckpt/MaskVLA/sim/put_object_cabinet/zero_primary_0.1 \
  --use_l1_regression True \
  --use_diffusion False \
  --use_film True \
  --num_images_in_input 3 \
